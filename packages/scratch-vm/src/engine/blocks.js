...
class Blocks {
    ...
    blocklyListen (e) {
        ...
        case 'create': {
            ...
            let newBlocks = null;
            if (e.test) {
              newBlocks = [{"id":"JndK.n|l7ntqWa$VB!2m","opcode":"motion_goto","inputs":{"TO":{"name":"TO","block":"YMr3Lyj7)}utvw_*@vR$","shadow":"YMr3Lyj7)}utvw_*@vR$"}},"fields":{},"next":null,"topLevel":true,"parent":null,"shadow":false,"x":"-358","y":"295"},{"id":"YMr3Lyj7)}utvw_*@vR$","opcode":"motion_goto_menu","inputs":{},"fields":{"TO":{"name":"TO","value":"_random_"}},"next":null,"topLevel":false,"parent":"JndK.n|l7ntqWa$VB!2m","shadow":true}]
            } else {
              newBlocks = adapter(e);
            }
        ...
        case 'move':
            ...
            //log.log("moving block with id " + e.blockId + " to coordinate (" + e.newCoordinate['x'] + ", " + e.newCoordinate['y'] + ")")
            break;
        case 'dragOutside':
